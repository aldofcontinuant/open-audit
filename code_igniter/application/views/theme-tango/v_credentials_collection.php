...
<table cellspacing="1" class="tablesorter">
	...
	<tbody>
		...
		<tr>
			...
			<td align='center'><?php echo "<a href=\"credentials/".intval($item->id)."?action=edit\"><img src='".$oa_theme_images."/16_edit.png' alt='' title='' style='width:16'/></a>"; ?></td>
			<td align='center'><?php echo "<a href='#' class='delete_link' data-name='" . htmlentities($item->name) . "' data-id='".intval($item->id)."' id='delete_link_".intval($item->id)."' name='delete_link_".intval($item->id)."'><img src='".$oa_theme_images."/16_delete.png' alt='' title='' style='width:16' /></a>"; ?></td>
		</tr>
		<?php endforeach; ?>
	</tbody>
</table>
