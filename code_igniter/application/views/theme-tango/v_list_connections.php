	...
	<tbody>
        ...
        if (count($query) > 0) {
            foreach ($query as $key):
                if ($key->id > 0) {
                    $edit_pic = "<a href=\"edit_connection/".intval($key->id)."\"><img src='".$oa_theme_images."/16_edit.png' alt='' title='' style='width:16'/></a>";
                    $delete_pic = "<a href=\"delete_connection/".intval($key->id)."\"><img src='".$oa_theme_images."/16_delete.png' alt='' title='' style='width:16'/></a>";
                    ?>
			<tr>
