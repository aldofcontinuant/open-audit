        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style='text-align:center;'><a class="btn btn-sm btn-info" href="credentials/<?php echo intval($item->id); ?>?action=update"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
                    <td style='text-align:center;'><button type="button" class="btn btn-sm btn-danger delete_link" aria-label="Left Align" data-id="<?php echo intval($item->id); ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
